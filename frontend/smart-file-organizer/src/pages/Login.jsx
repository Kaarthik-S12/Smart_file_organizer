            ...
            <div className="hidden lg:flex lg:w-[45%] bg-[#0f1117] flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div className="relative space-y-4">
                    <h2 className="text-3xl font-bold text-white leading-snug">
                        Organize your files<br />with intelligence.
                    </h2>
                    <p className="text-slate-400 text-base leading-relaxed max-w-sm">
                        AI-powered file classification and automated segregation — all in one place.
                    </p>
                    <div className="flex flex-col gap-2 pt-2">
                        {['ML-powered classification', 'Secure path validation', 'Works on any folder'].map((t) => (
